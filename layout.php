...
<head>  
	...
	<link rel="stylesheet" type="text/css" href="<?php echo $path; ?>/template/css/bootstrap.min.css?1350">
	<link rel="stylesheet" type="text/css" href="<?php echo $path; ?>/template/style.css?5876">
	<link rel="stylesheet" type="text/css" href="<?php echo $path; ?>/template/css/animate.min.css?819">
...
<script src="<?php echo $path; ?>/template/js/jquery-3.3.1.min.js?8271"></script>
<script src="<?php echo $path; ?>/template/js/bootstrap.bundle.min.js?8094"></script>
<script src="<?php echo $path; ?>/template/js/blocs.min.js?2531"></script>
<script src="<?php echo $path; ?>/template/js/jqBootstrapValidation.js"></script>
<script src="<?php echo $path; ?>/template/js/formHandler.js?7388"></script>
<script src="<?php echo $path; ?>/template/js/lazysizes.min.js" defer></script>
<script src="<?php echo $path; ?>/template/js/scrollFX.js?5243"></script>
<!-- Additional JS END -->
